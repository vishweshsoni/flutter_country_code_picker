...
class CountryPicker extends StatelessWidget {
  ...
  _renderDefaultDisplay(
      BuildContext context, Country displayCountry, Widget cancel) {
    return InkWell(
      child: Row(
  ...
  Future<Null> _selectCountry(
    ...
    final Country picked = await showCountryPicker(
        context: context, defaultCountry: defaultCountry, cancel: cancel);
...
Future<Country> showCountryPicker(
  ...
  return await showDialog<Country>(
    ...
    builder: (BuildContext context) =>
        _CountryPickerDialog(defaultCountry: defaultCountry, cancel: cancel),
  );
}
